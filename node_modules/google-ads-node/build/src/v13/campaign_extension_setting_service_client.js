 ...
 * `src/v13/campaign_extension_setting_service_client_config.json`.
...
class CampaignExtensionSettingServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v13.services.CampaignExtensionSettingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignExtensionSettingServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v13.services.CampaignExtensionSettingService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v13.services.CampaignExtensionSettingService, this._opts, this._providedCustomServicePath);
