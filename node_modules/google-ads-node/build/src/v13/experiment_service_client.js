 ...
 * `src/v13/experiment_service_client_config.json`.
...
class ExperimentServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        if (opts.fallback === 'rest') {
            ...
            lroOptions.httpRules = [{ selector: 'google.longrunning.Operations.CancelOperation', post: '/v13/{name=customers/*/operations/*}:cancel', body: '*', }, { selector: 'google.longrunning.Operations.DeleteOperation', delete: '/v13/{name=customers/*/operations/*}', }, { selector: 'google.longrunning.Operations.GetOperation', get: '/v13/{name=customers/*/operations/*}', }, { selector: 'google.longrunning.Operations.ListOperations', get: '/v13/{name=customers/*/operations}', }, { selector: 'google.longrunning.Operations.WaitOperation', post: '/v13/{name=customers/*/operations/*}:wait', body: '*', }];
        }
        this.operationsClient = this._gaxModule.lro(lroOptions).operationsClient(opts);
        const scheduleExperimentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const scheduleExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v13.services.ScheduleExperimentMetadata');
        const promoteExperimentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const promoteExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v13.services.PromoteExperimentMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v13.services.ExperimentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.experimentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v13.services.ExperimentService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v13.services.ExperimentService, this._opts, this._providedCustomServicePath);
    ...
    endExperiment(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers = options.otherArgs.headers || {};
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            'experiment': (_a = request.experiment) !== null && _a !== void 0 ? _a : '',
        });
        this.initialize();
    ...
    scheduleExperiment(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers = options.otherArgs.headers || {};
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            'resource_name': (_a = request.resource_name) !== null && _a !== void 0 ? _a : '',
        });
        this.initialize();
