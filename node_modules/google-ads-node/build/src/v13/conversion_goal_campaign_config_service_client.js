 ...
 * `src/v13/conversion_goal_campaign_config_service_client_config.json`.
...
class ConversionGoalCampaignConfigServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v13.services.ConversionGoalCampaignConfigService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversionGoalCampaignConfigServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v13.services.ConversionGoalCampaignConfigService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v13.services.ConversionGoalCampaignConfigService, this._opts, this._providedCustomServicePath);
