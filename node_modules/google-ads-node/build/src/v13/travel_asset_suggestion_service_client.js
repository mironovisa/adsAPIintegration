 ...
 * `src/v13/travel_asset_suggestion_service_client_config.json`.
...
class TravelAssetSuggestionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v13.services.TravelAssetSuggestionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.travelAssetSuggestionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v13.services.TravelAssetSuggestionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v13.services.TravelAssetSuggestionService, this._opts, this._providedCustomServicePath);
