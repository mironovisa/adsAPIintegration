 ...
 * `src/v13/batch_job_service_client_config.json`.
...
class BatchJobServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const runBatchJobMetadata = protoFilesRoot.lookup('.google.ads.googleads.v13.resources.BatchJob.BatchJobMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v13.services.BatchJobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.batchJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v13.services.BatchJobService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v13.services.BatchJobService, this._opts, this._providedCustomServicePath);
