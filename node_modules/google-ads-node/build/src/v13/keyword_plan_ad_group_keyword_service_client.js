 ...
 * `src/v13/keyword_plan_ad_group_keyword_service_client_config.json`.
...
class KeywordPlanAdGroupKeywordServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v13.services.KeywordPlanAdGroupKeywordService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanAdGroupKeywordServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v13.services.KeywordPlanAdGroupKeywordService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v13.services.KeywordPlanAdGroupKeywordService, this._opts, this._providedCustomServicePath);
