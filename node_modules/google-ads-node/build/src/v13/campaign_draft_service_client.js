 ...
 * `src/v13/campaign_draft_service_client_config.json`.
...
class CampaignDraftServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v13.services.CampaignDraftService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignDraftServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v13.services.CampaignDraftService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v13.services.CampaignDraftService, this._opts, this._providedCustomServicePath);
    ...
    promoteCampaignDraft(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers = options.otherArgs.headers || {};
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            'campaign_draft': (_a = request.campaign_draft) !== null && _a !== void 0 ? _a : '',
        });
        this.initialize();
