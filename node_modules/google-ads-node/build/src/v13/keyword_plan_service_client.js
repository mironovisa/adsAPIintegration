 ...
 * `src/v13/keyword_plan_service_client_config.json`.
...
class KeywordPlanServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v13.services.KeywordPlanService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v13.services.KeywordPlanService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v13.services.KeywordPlanService, this._opts, this._providedCustomServicePath);
    ...
    generateForecastCurve(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers = options.otherArgs.headers || {};
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            'keyword_plan': (_a = request.keyword_plan) !== null && _a !== void 0 ? _a : '',
        });
        this.initialize();
