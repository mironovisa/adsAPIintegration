 ...
 * `src/v13/smart_campaign_suggest_service_client_config.json`.
...
class SmartCampaignSuggestServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v13.services.SmartCampaignSuggestService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.smartCampaignSuggestServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v13.services.SmartCampaignSuggestService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v13.services.SmartCampaignSuggestService, this._opts, this._providedCustomServicePath);
